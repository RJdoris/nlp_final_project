...
from dataset import data_trans, spo_generate
...
valid_data = load_data('dataset/dev.txt')
predicate2id, id2predicate = {}, {}

with open('dataset/all_6_schemas') as f:
    for l in f:
        l = json.loads(l)
...
def evaluate(data):
    ...
    f = open('dataset/dev_pred.json', 'w', encoding='utf-8')
    pbar = tqdm()
    for d in data:
